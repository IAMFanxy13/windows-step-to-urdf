...
![Windows STEP-to-URDF workbench testing a generated tabletop robot arm](docs/images/interface-preview.png)
...
Want to explore without CAD data? Click **🧪 Example**. The included AP242 tabletop arm has a pedestal, shoulder and elbow servos, raised structural links, and a fixed two-finger gripper. It uses two instances of an MIT-licensed public SG51R servo body; every other part is generated by this repository. Exact provenance is in [Third-party notices](THIRD_PARTY_NOTICES.md).
